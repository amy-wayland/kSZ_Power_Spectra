...
plt.plot(k_arr, pkp_bi_3h, label=r'$P_{q_\parallel, B_{\rm 3h}}$', color='blueviolet', linewidth=2)
...
plt.plot(ells, get_Dl(ells, -clp_bi_3h), color="blueviolet", label=r'$D_{\ell, \parallel, B_{\rm 3h}}$', linewidth=2)
