...
def P_T_par(k_vec, cosmo, a, aHf, M_vals, nM_vals, bM_vals, interp_pg, interp_pe, interp_pM, trispectrum_func, P_L_interp, n_k=10, n_mu=10, n_phi=16):
...
def P_B_par(k_vec, cosmo, a, aHf, M_vals, nM_vals, bM_vals, interp_pa, interp_pM, bispectrum_func, P_L_interp, n_k=10, n_mu=10, n_phi=16):
