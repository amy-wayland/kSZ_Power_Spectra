...
def F_2(k_1_vec, k_2_vec):
    ...
    result = 5/7 + (1/2) * (dot_prod / (k_1_norm * k_2_norm)) * ((k_1_norm/k_2_norm) + (k_2_norm/k_1_norm)) + (2/7)*(dot_prod / (k_1_norm * k_2_norm))**2
    #print(f"F_2 = {result:.3e}")
    return result
...
def G_2(k_1_vec, k_2_vec):
    ...
    result = 3/7 + (1/2) * (1/k_1_norm**2 + 1/k_2_norm**2) * dot_prod + (4/7) * ((dot_prod) / (k_1_norm * k_2_norm))**2
    #print(f"G_2 = {result:.3e}")
    return result
